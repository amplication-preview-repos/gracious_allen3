...
class ReceiptUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ItemUpdateManyWithoutReceiptsInput,
  })
  @ValidateNested()
  @Type(() => ItemUpdateManyWithoutReceiptsInput)
  @IsOptional()
  @Field(() => ItemUpdateManyWithoutReceiptsInput, {
    nullable: true,
  })
...
export { ReceiptUpdateInput as ReceiptUpdateInput };
